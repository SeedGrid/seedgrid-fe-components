...
const K = "showcase.component.whistler";
...
export default function SgWhistlerPage() {
  const i18n = useShowcaseI18n();
  const aiComponent = useAiManifestComponent("SgWhistler");
    ...
    <I18NReady>
      ...
      >
        ...
        >
          ...
          <CodeBlock sampleFile="apps/showcase/src/app/components/sg-whistler/samples/base-setup.tsx.sample" />
        </Section>
        ...
        >
          <div className="flex flex-wrap gap-2">
            <SgButton onClick={() => sgWhistle.info({ title: t(i18n, `${K}.msg.rounded.title`), message: t(i18n, `${K}.msg.rounded.message`) })}>
              sgWhistle.info
            </SgButton>
            <SgButton appearance="outline" onClick={() => sgWhistle.dismiss()}>
              sgWhistle.dismiss
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <p className="mb-2 text-xs text-muted-foreground">rounded (default)</p>
              <div className="rounded-xl border border-dashed border-border p-3">
                <SgWhistler max={3} />
              </div>
            </div>
            <div>
              <p className="mb-2 text-xs text-muted-foreground">{"rounded={false}"}</p>
              <div className="rounded-xl border border-dashed border-border p-3">
                <SgWhistler max={3} rounded={false} />
              </div>
            </div>
          </div>
          <CodeBlock sampleFile="apps/showcase/src/app/components/sg-whistler/samples/rounded.tsx.sample" />
        </Section>
        ...
        >
          ...
          <CodeBlock sampleFile="apps/showcase/src/app/components/sg-whistler/samples/severities-and-stack.tsx.sample" />
        </Section>
        ...
        >
          ...
          <CodeBlock sampleFile="apps/showcase/src/app/components/sg-whistler/samples/actions-border-opacity.tsx.sample" />
        </Section>
        ...
        >
          ...
          <CodeBlock sampleFile="apps/showcase/src/app/components/sg-whistler/samples/update-by-id.tsx.sample" />
        </Section>
        ...
        >
          ...
          <CodeBlock sampleFile="apps/showcase/src/app/components/sg-whistler/samples/promise.tsx.sample" />
        </Section>
        ...
        >
          ...
          <CodeBlock sampleFile="apps/showcase/src/app/components/sg-whistler/samples/custom-renderer-and-colors.tsx.sample" />
        </Section>
        ...
        >
          <SgPlayground
            title="SgWhistler Playground"
            interactive
            codeContract="appFile"
            playgroundFile="apps/showcase/src/app/components/sg-whistler/sg-whistler.tsx.playground"
            height={640}
            defaultOpen
          />
        </Section>
