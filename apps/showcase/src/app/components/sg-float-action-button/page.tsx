...
export default function SgFloatActionButtonPage() {
  ...
  const fabPropsRows = React.useMemo<ShowcasePropRow[]>(
    () => [
      ...
      { prop: "severity / floatActionButtonStyle / color", type: "token / token / string", defaultValue: "primary / - / -", description: t(i18n, "showcase.component.fab.props.rows.severityColor") },
  ...
  return (
    <I18NReady>
      ...
      >
        ...
        <CodeBlock sampleFile="apps/showcase/src/app/components/sg-float-action-button/samples/drag-drop.tsx.sample" />
      </Section>
      ...
      >
        <SgPlayground
          ...
          playgroundFile="apps/showcase/src/app/components/sg-float-action-button/sg-float-action-button.tsx.playground"
          height={700}
          defaultOpen
        />
      </Section>
