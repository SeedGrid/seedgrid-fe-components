...
const COMPONENTS = [
  {
    ...
    items: [
      ...
      { slug: "sg-year-part-selector", name: "SgYearPartSelector", desc: "Seletor de recorte absoluto do ano (1o semestre de 2024, Q3 de 2023) que resolve para intervalo de datas" },
